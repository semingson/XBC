...
namespace XBC.MVC.Controllers
{
    public class BatchController : Controller
    {
        ...
        {
            ResponseResult result = BatchRepo.CreateEdit(model);
            return Json(new
            {
        ...
        public ActionResult Test(long? id, long? bt)
        {
            //id => Batch Test Id
            //ViewBag.BatchTestId = bt;
            //id => Batch Id
            ViewBag.BatchId = id;
            ViewBag.BatchTestId = new SelectList(BatchTestRepo.ByBatchTest(bt));
            return PartialView("_Test", TestRepo.GetBySearch(id/*, bt*/));
        }
        ...
        {
            ResponseResult result = BatchRepo.SaveBT(model);
            return Json(new
            {
                success = result.Success,
                message = result.Message,
